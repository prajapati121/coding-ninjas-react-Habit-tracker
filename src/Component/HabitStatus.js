...
const CalculateDayOfWeek = (date) => {
    // array storing date and day strings
    var days = new Array();
  
    // storing values in ascending order of date
    for (var i = 0; i < 7; i++) {
      ...
      // format the date and day name as a string
      var dateString = `${currentDate.toLocaleDateString('en-US')} - ${dayName}`;
  
      // store the formatted string
      days[i] = dateString;
    }
  
    // return the array of date and day strings
    return days;
  }
